...
in
  ...
  stdenv.mkDerivation rec {
    ...
    installPhase = ''
      ...
      #
      install -Dm755 showcolors.sh $out/bin/showcolors
      ...
      #
      wrapProgram $out/bin/showcolors --prefix PATH : '${makeBinPath buildInputs}'
    '';
    ##
  }
