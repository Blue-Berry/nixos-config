  ...
  config = lib.mkIf cfg.enable {
    xdg = {
      ...
      mimeApps.defaultApplications = {
        ...
        "x-scheme-handler/eclipse+command x-scheme-handler/eclipse+mpc" = [
          "_nix_store_jsjfg2zmqdp1r90kzkc5ld7409w0yaxg-CodeComposerStudio-12.6.0_ccs_eclipse_.desktop"
        ];
